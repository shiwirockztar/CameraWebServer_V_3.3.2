...
// Forward declarations from serial_cmds module
...
void setup() {
  ...
  // We don't call connect here from the serial module; do an initial connect
...
void loop() {
  // Dispatch serial commands handler (non-blocking)
  serialCmdsLoop();
